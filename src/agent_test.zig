...
test "Agent: struct field initialization" {
    ...
    var test_agent = agent.Agent.init(allocator, parsed.value, test_session_id);
...
test "Agent: init with minimal config" {
    ...
    var test_agent = agent.Agent.init(allocator, parsed.value, "minimal-test");
    defer test_agent.deinit();
...
test "Agent: init with web search API key" {
    ...
    var test_agent = agent.Agent.init(allocator, parsed.value, "web-search-test");
    defer test_agent.deinit();
...
test "Agent: ensure_system_prompt adds system message" {
    ...
    var test_agent = agent.Agent.init(allocator, parsed.value, "system-prompt-test");
    defer test_agent.deinit();
...
test "Agent: ensure_system_prompt doesn't duplicate" {
    ...
    var test_agent = agent.Agent.init(allocator, parsed.value, "no-duplicate-test");
    defer test_agent.deinit();
...
test "Agent: context operations" {
    ...
    var test_agent = agent.Agent.init(allocator, parsed.value, "context-test");
    defer test_agent.deinit();
...
test "Agent: tool registry functionality" {
    ...
    var test_agent = agent.Agent.init(allocator, parsed.value, "registry-test");
    defer test_agent.deinit();
...
test "Agent: chunk callback functionality" {
    ...
    var test_agent = agent.Agent.init(allocator, parsed.value, "chunk-test");
    defer test_agent.deinit();
...
test "Agent: shutdown flag functionality" {
    ...
    var test_agent = agent.Agent.init(allocator, parsed.value, "shutdown-test");
    defer test_agent.deinit();
...
test "Agent: last_chunk tracking" {
    ...
    var test_agent = agent.Agent.init(allocator, parsed.value, "last-chunk-test");
    defer test_agent.deinit();
...
test "Agent: indexConversation with disableRag" {
    ...
    var test_agent = agent.Agent.init(allocator, parsed.value, "rag-disabled-test");
    defer test_agent.deinit();
...
test "Agent: indexConversation with insufficient messages" {
    ...
    var test_agent = agent.Agent.init(allocator, parsed.value, "insufficient-msgs-test");
    defer test_agent.deinit();
...
test "Agent: memory management in deinit" {
    ...
    var test_agent = agent.Agent.init(allocator, parsed.value, "memory-test");
...
test "Agent: tool context creation" {
    ...
    var test_agent = agent.Agent.init(allocator, parsed.value, "tool-context-test");
    defer test_agent.deinit();
...
test "Agent: session ID handling" {
    ...
    for (session_ids) |session_id| {
        var test_agent = agent.Agent.init(allocator, parsed.value, session_id);
        defer test_agent.deinit();
...
test "Agent: configuration integration" {
    ...
    for (configs) |config_json| {
        ...
        var test_agent = agent.Agent.init(allocator, parsed.value, "config-test");
        defer test_agent.deinit();
